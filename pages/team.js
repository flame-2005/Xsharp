...
const team = () => {
  return (
    <div>
        <Navbar/>
       <section class="flex items-center py-24  font-poppins  ">
        <div class="justify-center flex-1 px-4 py-6 mx-auto max-w-7xl lg:py-4 md:px-6">
            <div class="mb-10 text-center">
                <span
                    class="block mb-4 text-xs font-semibold leading-4 tracking-widest text-center text-blue-500 uppercase dark:text-white">
                    Team
                </span>
                <h1 class="text-3xl font-bold capitalize dark:text-white"> Meet The Team </h1>
            </div>
            <div class="grid grid-cols-1 gap-4 lg:gap-8 sm:gap-4 sm:grid-cols-2 lg:grid-cols-2">
                <a class="flex flex-col flex-wrap mb-0 overflow-hidden rounded lg:flex-row dark:" href="#">
                    ...
                    <div
                        class="relative flex self-center flex-1 p-8 ml-0  border rounded shadow border-customBlue bg-black dark: lg:items-center lg:-ml-12">
                        <div>
                            <h2 class="mb-2 text-xl font-bold dark:text-customBlue">Henry Robinson</h2>
                            <p class="mb-4 text-sm text-blue-500 dark:text-blue-400">Director</p>
                            <p class="mb-4 text-sm text-white dark:text-white">
                                Lorem ipsum dolor sit amet, consectetu incididunt ut dolore magna aliqua. Ut enim ad
                                minim veniam
                            </p>
                            <div class="flex">
                                <span class="inline-block mr-5 text-gray-700 dark:text-white hover:text-blue-500 card">
